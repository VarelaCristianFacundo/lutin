    ...
    <div className="releases">
      <div className="release orange">
        <div className="content">
          ...
          Lutin Studios (LS) surge de la motivación por crear y coleccionar piezas de arte únicas, propias de la nueva era digital.
          Nos enfocamos exclusivamente en el mundo de la blockchain para construir una criptocultura cada vez más emocionante.
          En 100 años más queremos que la cultura de nuestros tiempos sea estudiada por las obras digitales creadas por Lutin Studios.
          </p>
          <p className="description">
